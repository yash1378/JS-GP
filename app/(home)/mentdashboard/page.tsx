...
export default async function Trial(){
    ...
    const Load=()=>{
      return(
                <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "85vh", backgroundColor: "black",width:"80vw",marginTop:'3vh',borderRadius:'20px', }}>
                    <CircularProgress />
    ...
    return (
        <>
         <div className="display-flex justify-center">
            ...
            <DataPage>
                <Suspense fallback={<Load/>}><MentServer/></Suspense> 
            </DataPage>
         </div>
        </>
    )
